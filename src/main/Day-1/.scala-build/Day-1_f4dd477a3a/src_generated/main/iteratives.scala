...
final class iteratives$_ {
def args = iteratives_sc.args$
def scriptPath = """iteratives.sc"""
/*<script>*/
...
object iteratives_sc {
  ...
  lazy val script = new iteratives$_
...
export iteratives_sc.script as `iteratives`
