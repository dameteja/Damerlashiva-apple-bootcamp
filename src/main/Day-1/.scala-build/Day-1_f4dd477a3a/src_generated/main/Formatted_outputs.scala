...
final class Formatted_outputs$_ {
def args = Formatted_outputs_sc.args$
def scriptPath = """Formatted_outputs.sc"""
/*<script>*/
...
object Formatted_outputs_sc {
  ...
  lazy val script = new Formatted_outputs$_
...
export Formatted_outputs_sc.script as `Formatted_outputs`
